...
public final class JBPMHelper {
    ...
    public static void startUp() {
        ...
        String driverClassName = properties.getProperty("persistence.datasource.driverClassName", "org.postgresql.Driver");
    ...
    public static TaskService startTaskService() {
        Properties properties = getProperties();
        String dialect = properties.getProperty("persistence.persistenceunit.dialect", "org.hibernate.dialect.PostgreSQLDialect");
